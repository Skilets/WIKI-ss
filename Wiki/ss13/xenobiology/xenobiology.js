function initializeXenobiologyPage() {
    ...
    const collapsibleButtons = [
        ...
        { button: '.collapsible-button-1', content: '.collapsible-content-1', textCollapsed: '2-3 уровень🔽', textExpanded: '2-3 уровень🔼' },
        { button: '.collapsible-button-2', content: '.collapsible-content-2', textCollapsed: '4 уровень🔽', textExpanded: '4 уровень🔼' },
